   ...
   */
    ...
    ?>    
		...
		<label for="<?php echo $id_show; ?>"><?php _e('Sort:', 'photo-gallery'); ?></label><br>
		  <input type="radio" name="<?php echo $name_show; ?>" id="<?php echo $id_show . "_1"; ?>" value="random" <?php if ($instance['show'] == "random") echo 'checked="checked"'; ?> /><label for="<?php echo $id_show . "_1"; ?>"><?php _e('Random', 'photo-gallery'); ?></label><br>
		  <input type="radio" name="<?php echo $name_show; ?>" id="<?php echo $id_show . "_2"; ?>" value="first" <?php if ($instance['show'] == "first") echo 'checked="checked"'; ?> /><label for="<?php echo $id_show . "_2"; ?>"><?php _e('First', 'photo-gallery'); ?></label><br>
		  <input type="radio" name="<?php echo $name_show; ?>" id="<?php echo $id_show . "_3"; ?>" value="last" <?php if ($instance['show'] == "last") echo 'checked="checked"'; ?> /><label for="<?php echo $id_show . "_3"; ?>"><?php _e('Last', 'photo-gallery'); ?></label>
		</p>
		<p>
